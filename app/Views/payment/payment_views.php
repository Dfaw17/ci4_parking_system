...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">DataTables Payment Methode</h6>
        </div>
        <a href="/payment/create" class="btn btn-primary col-2 m-3"> + Add Payment Methode</a>
                        ...
                        <?php foreach ($all_payment as $i) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/payment/delete/<?= $i->id ?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
